...
parser.add_argument('--synpg_model_path', type=str, default="./model_new/quora-bert40.pt",#,#./model_new/quora-albert40.pt",#"./model_finetune/quora_epoch50.pt",#"./model_finetune/rte_epoch-bert50.pt",#"./model_new/rte-distillbert40.pt",#"./model_finetune/mrpcfull_epoch50.pt",#./model/pretrained_synpg.pt",#"./finetune_full/synpg_epoch-140.pt",#"./model/pretrained_synpg.pt",#"model_finetune/synpg_epoch100020.pt",#"finetune_full/synpg_epoch-135.pt",#"./mrpc_finetune/synpg_epoch240.pt", #"./model/pretrained_synpg.pt", 
                       help="prtrained SynPG")
parser.add_argument('--pg_model_path', type=str, default="./model_parse/parse_quora_epoch30.pt",#
                       help="prtrained parse generator")
parser.add_argument('--train_data_path', type=str, default="./data/qqp_albert_right.h5",
                       help="input file")
parser.add_argument('--output_path', type=str, default="./qqp3/",
                       help="output file")
parser.add_argument('--output_path1', type=str, default="./qqp3-out/",
                       help="output file")
...
parser.add_argument('--max_sent_len', type=int, default=94,
                       help="max length of sentences")
parser.add_argument('--max_tmpl_len', type=int, default=100,
                       help="max length of tempalte")
parser.add_argument('--max_synt_len', type=int, default=270,
...
#tokenizer = AutoTokenizer.from_pretrained("textattack/distilbert-base-cased-QQP",cache_dir = './huggingface/token')
#modelclass = AutoModelForSequenceClassification.from_pretrained("textattack/distilbert-base-cased-QQP",cache_dir = './huggingface/model')
#tokenizer = AutoTokenizer.from_pretrained("textattack/bert-base-uncased-QQP",cache_dir = './huggingface/token')
#modelclass = AutoModelForSequenceClassification.from_pretrained("textattack/bert-base-uncased-QQP",cache_dir = './huggingface/model')
tokenizer = AutoTokenizer.from_pretrained("textattack/albert-base-v2-QQP",cache_dir = './huggingface/token/')
modelclass = AutoModelForSequenceClassification.from_pretrained("textattack/albert-base-v2-QQP",cache_dir = './huggingface/model/')
...
with open(os.path.join(args.output_path, f"output_my_albertattack-parse.txt"), "w") as fp1, \
    open(os.path.join(args.output_path, f"output_my_albertsen-parse.txt"), "w") as fp2,\
    open(os.path.join(args.output_path1, f"output_my_qqp-albert.txt"), "w") as fp3:
